...
<template>
  <Transition name="slide-fade">
    <div 
      ...
      class="fixed bottom-4 right-4 z-50 max-w-md bg-white rounded-lg shadow-lg border-l-4"
      :class="{
    ...
    >
      <div class="p-4 pr-10 flex items-start">
        <div 
          class="mr-3 text-xl"
          :class="{
        ...
        <div>
          ...
          <p class="text-gray-600">{{ currentError.message }}</p>
        </div>
        <button 
